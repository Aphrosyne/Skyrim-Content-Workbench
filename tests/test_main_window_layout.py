...
_ALL_KEYS = (
    ...
    ui.QSETTINGS_KEY_LIST_ICON_SIZE,
    ...
    ui.QSETTINGS_KEY_ICON_COLOR_FOLDER,
    ui.QSETTINGS_KEY_ICON_COLOR_ARCHIVE,
    ui.QSETTINGS_KEY_ICON_COLOR_IMAGE,
    ui.QSETTINGS_KEY_ICON_COLOR_DOCUMENT,
)
